        ...
        return (
            <div>
                ...
                <Card title="loading按钮">
                    ...
                    <Button type="primary" onClick={this.handleClickLoading}>关闭按钮</Button>
                </Card>
                ...
                <Card title="按钮尺寸">
                    ...
                    <Button size={size} type="primary">主按钮</Button>
                    <Button size={size}>普通按钮</Button>
                    <Button size={size} type="dashed">虚线按钮</Button>
                    <Button size={size} type="danger">危险按钮</Button>
                    <Button size={size} disabled>普通按钮</Button>
                </Card>
            </div>
        )
    }
